...
function fetchWeatherData() {
    ...
    .then(data => {
        ...
        if (code === 1000)
        {
            ...
            app.style.backgroundImage = 'url(/iWeather/images/' + timeOfDay + '/clear.jpg)';
            ...
            // cloudy weather
            app.style.backgroundImage = 'url(/iWeather/images/' + timeOfDay + '/cloudy.jpg)';
            ...
            // snowy weather
            app.style.backgroundImage = 'url(/iWeather/images/' + timeOfDay + '/snowy.jpg)';
